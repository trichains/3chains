...
export const PortfolioIcon = ({ className, ...rest }) => {
  return (
    <svg
      ...
      <path
        fill="#EEE0B1"
        d="m10.648 7.276 1.874 3.082-8.814 5.357 12.29 7.52-1.928 3.18L0 17.312v-3.166l10.648-6.87ZM21.352 24.138l-1.874-3.081 8.814-5.357-12.29-7.52L17.93 5 32 14.103v3.166l-10.648 6.87Z"
      />
    </svg>
  );
};
