...
export const PortfolioIcon = ({ className, ...rest }) => {
  return (
    <svg
      ...
      className={cx('w-full h-auto', className)}
      {...rest}>
      <rect width={32} height={32} fill="#191411" rx={16} />
      <path
        fill="#EEE0B1"
        d="m11.986 9.7 1.405 2.303-6.61 4.003 9.218 5.618L14.552 24 4 17.199v-2.366l7.986-5.132ZM20.014 22.3l-1.405-2.303 6.61-4.002-9.218-5.619L17.448 8 28 14.801v2.366l-7.986 5.132Z"
      />
    </svg>
  );
};
