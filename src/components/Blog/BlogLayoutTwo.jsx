      ...
      <div className="col-span-8 w-full">
        ...
        <Link href={blog.url} className="inline-block my-1">
          <h2 className="font-semibold capitalize text-lg">
            <span className="bg-gradient-to-r from-accent/50 to-accent/50 bg-[length:0px_4px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500 hover:bg-[length:100%_4px]">
              {blog.title}
            </span>
          </h2>
        </Link>

        <span className="text-dark/50 font-medium text-base">
