    ...
    <div className="inline-block overflow-hidden rounded-xl">
      ...
      <div className="w-full absolute bottom-0 p-10 z-20">
        ...
        <Link href={blog.url} className="mt-6">
          <h2 className="font-bold capitalize text-2xl text-textAccent mt-4">
            <span className="bg-gradient-to-r from-accent to-accent bg-[length:0px_4px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500 hover:bg-[length:100%_4px]">
              {blog.title}
            </span>
          </h2>
        </Link>
